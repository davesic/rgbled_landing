...
<head>
    ...
    <title>Згода на обробку даних</title>
    <style>
	body, html{
    min-height: 100%;
    margin:0px;
...
<div class="block_more_info">
    ...
    <p>Згода на обробку персональних даних
Користувач, оформляючи заявку на нашому сайті (далі - Сайт), погоджується з умовами цієї Згоди на обробку персональних даних (далі - Згода) відповідно до Закону України "Про захист персональних даних". Прийняттям (акцептом) оферти Згоди є відправка заявки з Сайту або замовлення у Оператора за телефонами Сайту.</p>

	<h2>Користувач дає свою згоду на обробку своїх персональних даних з наступними умовами:</h2>

    <p>1. Дане Згода дається на обробку персональних даних як без, так і з використанням засобів автоматизації.</p>
	   <p>2. Згода поширюється на наступну інформацію: прізвище, ім'я, по батькові, телефон, електронна пошта.</p>
    ...
    <p>5.Персональні дані обробляються Оператором до завершення всіх необхідних процедур. Також обробка може бути припинена за запитом Користувача на електронну пошту: <font color="Navy">support@rgb.shopistars1.fun</font></p>
    <p>6. Користувач підтверджує, що, даючи Згода, він діє вільно, своєю волею і в своєму інтересі.</p>
    <p>7.Справжнє Згода діє безстроково до моменту припинення обробки персональних даних з підстав, зазначених у п.6 даного документа.</p>
...
<!-- Localized -->
<center><a href="index.php">На головну</a><a></a></center></body>
</html>